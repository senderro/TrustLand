...
export async function POST(
  ...
  try {
    ...
    const isJustified = justificationChecks.hasOverdueInstallments && 
      (justificationChecks.multipleOverdue || justificationChecks.severelyOverdue);
    ...
    await eventManager.createEvent(
      EventHelpers.loanDefaulted(loanId)
    );
